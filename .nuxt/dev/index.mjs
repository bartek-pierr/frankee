...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/devalue/index.js';
import destr from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/pierr/Desktop/workshop/projects/frankee/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/pierr/Desktop/workshop/projects/frankee/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/pierr/Desktop/workshop/projects/frankee","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/pierr/Desktop/workshop/projects/frankee/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/pierr/Desktop/workshop/projects/frankee/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/pierr/Desktop/workshop/projects/frankee/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/pierr/Desktop/workshop/projects/frankee/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _d7H1YNOcWs = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/pierr/Desktop/workshop/projects/frankee";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _3pfENdBfX2 = (nitroApp) => {
...
const _lazy_GmcwFj = () => Promise.resolve().then(function () { return frankeeData$1; });
const _lazy_tMbykK = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/frankeeData', handler: _lazy_GmcwFj, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_tMbykK, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_tMbykK, lazy: true, middleware: false, method: undefined }
];
...
const frankeeData = defineEventHandler(() => {
  return {
    config: {
      mail: "hello@frankee.com.pl",
      phone: "665 865 789",
      facebookURL: "https://www.facebook.com/profile.php?id=100095526155357",
      instagramURL: "https://www.instagram.com/frankee_minimal/",
      tiktokURL: "https://www.tiktok.com/@frankee_minimal"
    }
  };
});

const frankeeData$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: frankeeData
});
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Pierwsza agencja social media w Karkonoszach."},{"name":"author","content":"Bartek Pierr"}],"link":[{"rel":"stylesheet","href":"https://fonts.googleapis.com/icon?family=Material+Icons"}],"style":[],"script":[],"noscript":[],"title":"Frankee."};
...
const getClientManifest = () => import('file:///Users/pierr/Desktop/workshop/projects/frankee/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/pierr/Desktop/workshop/projects/frankee/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
